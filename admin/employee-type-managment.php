...
<div class="card-header">
	<div class="row">
		<div class="col-md-8">
		<h4 class="card-title mb-0">Employee Type </h4>
...
<input type="hidden"value="empmanagment"id="anchor_value">
...
<td width="10%">
    ...
    <a href="delete.php?action=employee&id='.$row['id'].'"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></a>
